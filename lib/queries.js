const { contains } = require("effect/Option");
...
module.exports = {findUser, findUserById, createUser, fileUpload, getUserAssets, checkFolderExists, createFolder, toggle, getAllAssets, checkUserOwnsAsset, deleteFromDB, getAllAssetsInsideAFolder, renameFromDB, renameFromDBWhenFolderRenamed, getAllAssetsFromRoot, getdownloadLink, searchAssets}
